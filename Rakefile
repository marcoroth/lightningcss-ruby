...
begin
  ...
  Rake::ExtensionTask.new do |ext|
    ext.name = "lightningcss"
    ext.source_pattern = "*.{c,h}"
    ext.ext_dir = "ext/lightningcss"
    ext.lib_dir = "lib/lightningcss"
    ext.gem_spec = Gem::Specification.load("lightningcss.gemspec")
  ...
  task :cargo do
    ...
    FileUtils.rm_f(Dir.glob("tmp/*/lightningcss/*/lightningcss.{bundle,so}"))
  end
  ...
  namespace "gem" do
    task "prepare" do
      ...
      gemspec_path = File.expand_path("./lightningcss.gemspec", __dir__)
